...
SKIP_SENDERS = [
    ...
    "harshithacloud81@gmail.com",      # own SMTP send account
]
...
def fetch_matching_emails():
    ...
    log.info(f"Gmail {REPLIED_LABEL} label: {len(replied_ids)} emails")
...
def main():
    ...
    log.info(f"SEND from  : harshithacloud81@gmail.com (SMTP_EMAIL)")
