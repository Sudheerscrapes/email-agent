...
Sends: rajumodhala777@gmail.com (SMTP)
Replies to: SRE, DevOps, Cloud Engineer, Kubernetes, Terraform, Monitoring roles
...
# ══════════════════════════════════════════════════════════════════════════════
# ROLES - Updated to match Lingaraju Modhala's resume (SRE, DevOps, Cloud,
#         Kubernetes, Terraform, Monitoring/Observability)
# ══════════════════════════════════════════════════════════════════════════════
ROLES = [
    {
    ...
    {
        "name": "Infrastructure / Terraform / Automation Engineer",
        "keywords": [
            "terraform engineer",
            "terraform developer",
            "terraform architect",
...
def main():
    log.info("=" * 70)
    log.info("AI Email Agent - Lingaraju Modhala")
    ...
    log.info("SEND account : %s", os.environ.get("SMTP_EMAIL"))
